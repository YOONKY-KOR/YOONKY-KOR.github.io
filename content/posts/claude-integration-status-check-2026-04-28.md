---
title: "Claude 연동 전체 상태 체크 리포트 (2026-04-28)"
date: 2026-04-20
draft: false
...
> Claude Code와 연동된 모든 시스템의 현재 상태를 점검한 헬스체크 리포트입니다. 점검일: **2026-04-28**
...
- 🏡 Home
    - 💼 Work Hub → AI / Engineering KB / Azure / Blog / Inbox / Tasks & Projects / CRM & Meetings
    - 🏠 Personal Hub → Finance / Daily / Habits / Time Management / Goals & Growth / Health / Travel
    - 📚 Knowledge Hub → Notes / Library / Travel / Architecture Insights / 기타
    - 🗂️ Archive
...
- [x] Blog Post DB Category 옵션 `Claude/AI` → `AI` 통일 완료
- [x] notion-sync.js CATEGORY_MAP 정비 (Japan Life 제거, AI 단일화)
- [x] Workspace Guide 실제 구조 반영 업데이트
- [x] hugo/[README.md](http://readme.md/) DB 속성 정보 정정
...
_Generated by Claude Code — 2026-04-28 | Last updated: 2026-04-28 (Category 정비, Workspace 구조 반영)_
